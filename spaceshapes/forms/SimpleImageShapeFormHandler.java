...
public class SimpleImageShapeFormHandler implements FormHandler {
	 ...
	 * @param parent the CarrierShape object that will serve as the parent for a
	 *               new ImageRectangleShape instance.
	 */
	public SimpleImageShapeFormHandler(ShapeModel model, CarrierShape parent) {
		_model = model;
		_parentOfNewShape = parent;
	}

	/**
	 * Reads form data that describes an ImageRectangleShape. Based on the data,
	 * this SimpleImageShapeFormHandler creates a new ImageRectangleShape
	...
	public void processForm(Form form) {
		...
		ImageRectangleShape imageShape = new ImageRectangleShape(deltaX, deltaY,
				scaledImage);
